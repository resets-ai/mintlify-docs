...
Our search API orchestrates queries across three powerful search engines:

- **Serper** - Google search results with rich metadata
- **EXA** - Neural search for semantic understanding
- **Jina** - Advanced search with content extraction
...
### Structured Query (LinkedIn Search)
...
| limitResults       | integer | No       | 10      | Results to return (1-500)       |
