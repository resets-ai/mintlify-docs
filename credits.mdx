...
| /search AI Page Summary  | 1 credit                  | Extract page summary from search results. (limited to the first 25 results) |
| /extract                 | 1 credit                  | Get all website contents  in markdown                                       |
| /extract AI Page Summary | 1                         | Extract page summary from extract results                                   |
